...
import ganhuo.ly.com.ganhuo.mvp.meizi.fragment.HuaFragment;
...
public class SisterPagerAdapter extends FragmentStatePagerAdapter {


    public SisterPagerAdapter(FragmentManager fm) {
        super(fm);
    }
    ...
    public Fragment getItem(int i) {
        ...
        HuaFragment newFragment = HuaFragment.getInstance();
        return newFragment;
    }
